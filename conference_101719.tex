...
\title{User’s response to robots with different conversational styles\\
...
\and
\IEEEauthorblockN{Weiye Wang}
\IEEEauthorblockA{\textit{Department of Engineering Mathematics} \\
\textit{University of Bristol}\\
Bristol, UK \\
hg22773@bristol.ac.uk}
\and
\IEEEauthorblockN{ Yogesh Muthu Ram Mariyappan}
\IEEEauthorblockA{\textit{Department of Engineering Mathematics} \\
\textit{University of Bristol}\\
Bristol, UK \\
gl22264@bristol.ac.uk}
\and
\IEEEauthorblockN{Worayut Aksornukul}
\IEEEauthorblockA{\textit{Department of Engineering Mathematics} \\
\textit{University of Bristol}\\
Bristol, UK \\
nm22393@bristol.ac.uk}
\and
\IEEEauthorblockN{ Ancheng Wang}
\IEEEauthorblockA{\textit{Department of Engineering Mathematics)} \\
\textit{University of Bristol)}\\
Bristol, UK \\
ls22066@bristol.ac.uk}
