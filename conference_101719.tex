...
\textbf{The independent variable} of the experiment is the attitude of the robot. To verify our hypothesis, we designed two sets of dialogues for the same interaction content in our experiment. Both sets of dialogues serve the same guiding and interactive purpose, but their tone is different. One set of dialogues was designed to be friendly, funny and polite, while the other set was designed to be sarcastic and caustic.
...
\textcolor{blue}{\textit{A brief overview of the participants you had (number of participants, 
gender distribution, average age, pre experience, etc.).}}
