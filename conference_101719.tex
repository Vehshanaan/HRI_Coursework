...
The size of the data is too small (7 participants for each group), and does not meet the requirement of normal distribution. So the data will be tested with Mann-Whitney U test. In addition, \textbf{The size of effect is measured with Cohen's d}.
